...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx in range(args.eval_step):
            ...
            mask = ((max_probs.ge(args.threshold)) & (mem_tc[index].ge(threshold))).float()
            mask_index = (max_probs.ge(args.threshold)) & (mem_tc[index].ge(threshold))
            ...
            mem_tc[index] = 0.99 * mem_tc[index] - 0.01 * at
